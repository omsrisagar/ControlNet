...
if __name__ == "__main__":
    ...
    logger_freq = 300
    # learning_rate = 1e-5
    learning_rate = 1e-5 # to account for 4 gpus and effective batch size of 16
    sd_locked = True
    ...
    save_checkpoint = CheckpointEveryNSteps(save_step_frequency=logger_freq, use_modelcheckpoint_filename=f'latest-{logger_freq}-step-checkpoint.ckpt')
